            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-6 mb-10 pb-10">
                <div className="flex items-center gap-3 pr-6 border-r border-white/10">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-[#6C2BFF] to-[#EC4899] p-0.5">
                    <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt={course.instructor} className="w-full h-full rounded-full border-2 border-[#05050A]" />
                  </div>
                  <div>
                    <div className="text-xs text-[#A88CFF] font-medium mb-0.5">Instructor</div>
                    <div className="text-sm font-bold text-white mb-0.5">{course.instructor}</div>
                    <div className="text-xs text-gray-400">AI Engineer & Educator</div>
                  </div>
                </div>

                <div className="flex items-center gap-2 pr-6 border-r border-white/10">
                  <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                  <span className="text-lg font-bold text-yellow-400">{course.rating}</span>
                  <span className="text-xs text-gray-400 mt-1">({course.total_reviews ? (course.total_reviews / 1000).toFixed(2) + 'K' : '2.31K'} reviews)</span>
                </div>

                <div className="pr-6 border-r border-white/10">
                  <div className="text-lg font-bold text-white mb-0.5">{course.total_reviews ? (course.total_reviews * 5.5).toLocaleString() : '12,540'}</div>
                  <div className="text-xs text-gray-400">Students Enrolled</div>
                </div>
                
                <div className="pr-6 border-r border-white/10">
                  <div className="text-lg font-bold text-[#A88CFF] mb-0.5">{course.total_hours} hrs</div>
          ...
          <div className="flex-1 relative z-10 w-full max-w-[600px]">
            ...
            <div className="bg-[#FAF9FF] text-center p-8 border-[8px] border-[#D1D5DB] rounded-lg shadow-2xl relative transform rotate-2 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="flex justify-between items-end px-4">
                <div className="text-center"><div className="border-b border-gray-400 w-24 pb-1 mb-1 text-[10px] italic">Adarsh Singh</div><div className="text-[8px] text-gray-500 uppercase">Instructor</div></div>
