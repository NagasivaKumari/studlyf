...
import { MailCheck, CheckCircle2, XCircle, ArrowLeft } from 'lucide-react';
        ...
        const verifyEmail = async () => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    setError(data.detail || "Failed to verify email. Link may be expired or invalid.");
                }
            } catch (err) {
            ...
            <AuthCard title="Email Verification" maxWidth="max-w-[450px]">
                {loading ? (
                    ...
                    >
                        ...
                        <button
                            onClick={() => navigate('/login')}
                            className="w-full py-4 bg-gray-50 text-gray-500 rounded-xl font-bold uppercase tracking-widest text-[11px] hover:bg-gray-100 transition-all flex items-center justify-center gap-2"
                        >
