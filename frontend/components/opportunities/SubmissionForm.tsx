...
const SubmissionForm: React.FC<SubmissionFormProps> = ({ eventId, stage }) => {
    ...
    if (!eventId || !stageId) {
        return (
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-slate-600">Submission stage is not configured yet.</p>
            </div>
        );
    }
    ...
    if (!registered) {
        return (
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-2xl font-bold mb-2">Project Submission</h2>
                <p className="text-slate-600">Please register for this event before submitting.</p>
            </div>
        );
    }
    ...
    if (teamRequired && !teamId) {
        return (
            <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-2xl font-bold mb-2">Project Submission</h2>
                <p className="text-slate-600">Create or join a team to submit for this stage.</p>
            </div>
        );
    }
